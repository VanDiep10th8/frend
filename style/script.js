window.addEventListener('load', () => {
    const messages = [
        "Chúc em luôn bình an, hạnh phúc và tìm thấy niềm vui trong mỗi ngày 🌸",
        "Mong em luôn khoẻ mạnh, hạnh phúc và đạt được mọi điều mình mong ước nhé 💖",
        "Hãy cứ mạnh mẽ, tự tin bước đi trên con đường mình chọn 💕",
        "Chúc em mãi luôn tươi tắn và rạng rỡ! 🌷",
        "Chúc em luôn chăm ngoan và tiếp thu kiến thức thật tốt! 💫"
    ];
